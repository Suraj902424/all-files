...
$dbUser = "root";
$dbPass = "";
$dbName = "hospital"; // Ensure this is your actual database name
...
$baseURL = "http://localhost/hospital/admin/";
...
$tblAppointment     = "tbl_appointment";
...
$tblDepartment     = "tbl_doctor";
$urlDepartment     = "department.php";
$urlDepartmentList = "department-list.php";




$tblPrice     = "tbl_packages";
$urlPrice     = "price.php";
$urlPriceList = "price-list.php";
