...
include 'dbc.php';
$pageTitle = "List of Course Category ";
$pageName = " Course Category";
$tableName = $tblDepartment;
$addPageUrl = $urlDepartment;
$deleteMode = "deleteData";
$returnurl = $urlDepartmentList;
$imageUrl = $mainPath;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="order-actions">
                                                        <a href="department.php?id=<?= $row['id'] ?>" class="btn btn-success"><i class="bx bxs-edit"></i></a>
