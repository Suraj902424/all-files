...
$tableName = $tblPrice; // Defined in dbc.php
$listPageUrl = $urlPriceList; // Defined in dbc.php
...
<body>
    ...
    <input type="text" id="applicationname" name="title" class="form-control" 
        value="<?= htmlspecialchars($serviceData['title'] ?? '') ?>">
</div>
 
                                    <div class="col-xs-12 col-sm-6">
                                        <label>price</label>
                                        <input type="text" id="applicationname" name="price" class="form-control" value="<?php echo htmlspecialchars($serviceData['price'] ?? ''); ?>">
                                    </div>
                                    <div class="col-xs-12 col-sm-6">
                                        <label>	duration</label>
                                        <input type="text" id="setpageName" name="duration" class="form-control" value="<?php echo htmlspecialchars($serviceData['duration'] ?? ''); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <textarea name="features" class="editor"><?php echo htmlspecialchars($serviceData['features'] ?? ''); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="display: none;">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="simple_data[]" multiple>
                                            ...
                                            <option value="price" selected>heading</option>
                                            <option value="duration" selected>duration</option>
                                            <option value="features" selected>description</option>
