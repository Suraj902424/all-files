...
$tableName = $tblPrice ?? 'tbl_packages'; // Use a default if not defined in dbc.php
$addPageUrl = $urlPrice  ?? 'price.php'; // Use a default if not defined in dbc.php
$returnurl = $urlPriceList?? 'price-list.php'; // Use a default if not defined in dbc.php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="order-actions">
                                                    <!-- Edit Button -->
                                                    <a href="price.php?id=<?= htmlspecialchars($row['id']) ?>" class="btn btn-success" title="Edit"><i class="bx bxs-edit"></i></a>
                                                    <!-- Delete Button -->
