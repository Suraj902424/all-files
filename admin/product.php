...
$pageName    = "Product";
$linkName    = "Show All Product";
$editMode    =   "editData";
$addMode    =   "addData";
$tableName   = $tblProduct;
$listPageUrl = $urlProductList;
$imageUrl = $mainPath;
                        ...
                        <div class="panel-body">
                            ...
                            <form id="InsertUpdateForm" role="form" action="" method="post"
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        <label>Price </label>
                                        <input type="text" name="price" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['price'] : "" ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <input type="text" name="base_price" class="form-control" value="<?php echo (isset($_GET['id'])) ? $serviceData['base_price'] : "" ?>">
                                    </div>
                                </div>
                                <!--image section end-->
                                <div class="form-group row" style="display: none;">
                                    <div class="col-xs-12 col-sm-12">
                                        ...
                                        <select name="simple_data[]" id="" multiple>
                                            ...
                                            <option value="base_price" selected >base_price</option>
                                        </select>
                                    </div>
                                </div>
                                <hr>
